      ...
      <form className="form">
        <table className="tableCase">
          <div className="divTable">
            ...
            <p className="pTable">
              Este es un caso de abandono y descuido infantil.
            </p>
          </div>
          <div className="divTable">
            <h5 className="titleTable">Case of Mr. Castro</h5>
        ...
        <div className="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
          <button
            className="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center show"
            id="bd-theme"
            type="button"
            aria-expanded="true"
          ...
          >
            <svg className="bi my-1 theme-icon-active" width="1em" height="1em">
              <use href={ColorIcons + "#moon-stars-fill"}></use>
            </svg>
          ...
          <ul
            className="dropdown-menu dropdown-menu-end shadow show position: absolute; inset: auto 0px 0px auto; margin: 0px; transform: translate(0px, -44px);"
          ...
          >
            <li>
              ...
              >
                <svg className="bi me-2 opacity-50" width="1em" height="1em">
                  <use href={ColorIcons + "#sun-fill"}></use>
                </svg>
                Light
                <svg className="bi ms-auto d-none" width="1em" height="1em">
                  <use href={ColorIcons + "#check2"}></use>
                </svg>
              </button>
            </li>
            <li>
            ...
            <li>
              ...
              >
                <svg className="bi me-2 opacity-50" width="1em" height="1em">
                  <use href={ColorIcons + "#circle-half"}></use>
                </svg>
                Auto
                <svg className="bi ms-auto d-none" width="1em" height="1em">
                  <use href={ColorIcons + "#check2"}></use>

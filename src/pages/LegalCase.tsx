    ...
    <div className="container">
      <form className="row g-3 px-5 mt-3">
        <div className="col-md-4">
          <label htmlFor="inputCaseId" className="form-label">
            Case ID
          </label>
        ...
        <div className="col-4">
          <label htmlFor="inputLawyerId" className="form-label">
            Lawyer ID
          </label>
          <input type="number" className="form-control" id="inputLawyerId" />
        </div>
        <div className="col-12">
          <label htmlFor="inputCaseTitle" className="form-label">
            Case Title
          </label>
        ...
        <div className="col-md-6">
          <label htmlFor="inputDateFiled" className="form-label">
            Date Filed
          </label>
          <input type="date" className="form-control" id="inputDateFiled" />
        </div>
        <div className="col-md-6">
          <label htmlFor="inputRelevantStatues" className="form-label">
            Relevant Statues
          </label>
          <input
            type="text"
            className="form-control"
            id="inputRelevantStatues"
          />
        </div>
        <div className="col-md-6">
          <label htmlFor="inputRelevantStatues" className="form-label">
